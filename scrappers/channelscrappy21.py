...
videoStatsFile = open('../datasets/8mcsvs/videoStats21.csv', 'r')
videoStatsBridge = csv.DictReader(videoStatsFile)
cunt = 0
channelStatsFile = open('../datasets/8mcsvs/8mchannels/channelStats21.csv', 'w')
...
for videoStat in videoStatsBridge:
    ...
    payload_channel = "https://www.googleapis.com/youtube/v3/channels?key=AIzaSyAjkrSgzR6voSP3ut1Mj1ukkAZ_xYtEC_0" \
