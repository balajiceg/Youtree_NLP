...
video_data_reader = open('../datasets/tensorVideoID22.csv', 'r')
video_data_reader.__next__()
video_channel_data = csv.reader(video_data_reader)
video_data_writer = open('../datasets/8mcsvs/videoStats22.csv', 'a')
...
for row in video_channel_data:
    payload = "https://www.googleapis.com/youtube/v3/videos?id="+row[0]+ \
            "&key=AIzaSyDko47ncNpqJLWr55JF1PqKzi658XG-eJE&part=snippet,contentDetails,statistics,status"
